  ...
  return (
    <>
      <header className={style.headerContainer}>
        ...
        <nav className={style.headerContainer__navbar}>
          <section className={style.headerContainer__navbar__navigation}>
            <div
              className={style.headerContainer__navbar__navigation__item}
            >
              <a href="#">Home</a>
            </div>
            <div
          ...
          <section className={style.headerContainer__navbar__action}>
            <div
              className={style.headerContainer__navbar__action__item}
            >
              <a
                href="#"
              >
